...
public class ComparativaCasosLenguajes {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Double> dataMapJava = LeerResultados.readDataFromFileSpecific(Archivo.getPath("/src/main/resources/resultados_Java.txt"), caso);
        Map<String, Double> dataMapPython = LeerResultados.readDataFromFileSpecific(Archivo.getPath("/src/main/resources/resultados_Python.txt"), caso);
